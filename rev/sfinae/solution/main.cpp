...
// PRNG: https://en.wikipedia.org/wiki/Wichmann%E2%80%93Hill
...
// Generators for the real and imaginary components
...
// Matrix builder: iterate through each row and column and call the PRNG
...
// Definitions for each character
...
// Scalar product: done bit by bit to avoid instantiating thousands of templates
...
int main() {
  static_assert(wctf<_s, _3, _t, _t, _1, _n, _6, __, _t, _h, _3, __, _f, _l, _4, _g, __, _1, _s, __, _n, _0, _t, __, _4, _n, __, _3, _r, _r, _0, _r>::valid);
}
